...
<head runat="server">
    <title>ArmandoMG0202Delete</title>
</head>
<body>
    <h3>Estas segur@ que quieres borrar la siguiente informacion?</h3>
    <fieldset>
    ...
    <% using (Html.BeginForm()) { %>
        <p>
		    ...
		    <%: Html.ActionLink("Regresar a la lista de videos", "ArmandoMG0202") %>
        </p>
    <% } %>
