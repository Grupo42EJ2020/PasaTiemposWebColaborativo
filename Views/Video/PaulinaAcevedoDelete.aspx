...
<head runat="server">
    <title>Borrar un video PaulinaAcevedo</title>
</head>
<body>
    <h3>¿Esta seguro de Borrar la sigiente informacion? </h3>>
    <fieldset>
    ...
    <% using (Html.BeginForm()) { %>
        <p>
		    ...
		    <%: Html.ActionLink("Regresar a la lista de videos", "/PaulinaAcevedo") %>
        </p>
    <% } %>
