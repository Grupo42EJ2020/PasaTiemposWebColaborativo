...
<head runat="server">
    <title>BORRAR VIDEO!!! RodVillarreal20Delete</title>
</head>
<body>
    <h3>¿ESTAS SEGURO DE QUE DESEAS BORRAR ESTO?</h3>
    <fieldset>
    ...
    <% using (Html.BeginForm()) { %>
        <p>
		    ...
		    <%: Html.ActionLink("Regresar a la lista de videos", "/RodVillarreal20") %>
        </p>
    <% } %>
